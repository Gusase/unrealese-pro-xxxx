...
@section('content')
    ...
    <div class="max-w-2xl px-1.5 sm:px-0 py-5 lg:mx-auto">
        <form method="post" action="/file/{{ $file->id_file }}" enctype="multipart/form-data" id="form">
            @csrf
            @method('put')
            ...
            <div
              ...
              after:bg-gray-900/20">
                <h2 class="text-2xl font-normal font-mona leading-7 text-gray-900 pb-1">Edit file</h2>
            </div>
            ...
            <div class="mt-6">
                ...
                <input
                    ...
                    id="judul_file" type="text" name="judul_file" value="{{ old('judul_file', $file->judul_file) }}"
                    required />
                @error('judul_file')
            ...
            <div class="mb-4">
                ...
                <textarea
                    ...
                    placeholder="Tambahkan deskripsi disini" id="floatingTextarea2" style="height: 100px" name="deskripsi">{{ old('deskripsi', $file->deskripsi) }}</textarea>
                @error('deskripsi')

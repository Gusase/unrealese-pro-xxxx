...
@section('content')
    <div class="max-w-4xl py-5 xl:mx-auto mt-10">
        ...
        <form action="/user/{{ $user->id_user }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
              ...
              after:bg-gray-900/20">
                ...
                <div class="w-1/3 -mx-1.5">
                    <div class="flex flex-col items-center sm:mt-5">
                        <button type="button"
                            class="w-48 h-48 focus:outline-none focus:ring-1 focus:ring-gray-400 ring-offset-4 rounded-full duration-100 group relative" onclick="openFile()">
